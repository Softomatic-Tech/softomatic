						...
						@endforeach
						            			...
						            			<div class="row clearfix">
													<div class="form-group">
						            					...
						            					<div class="col-md-8 col-sm-6 col-xs-12">
							            					<div class="form-line">
							            						<select class="form-control salary_value" name="reason_for_code"  >
...
<script type="text/javascript">
	function personal_details(){
		...
		$count=0;
				if($('#reason_for_code').val()!='' && $('#last_working_day').val()!='' && $('#genesis_ledger_id').val()!='' && $('#genesis_id').val()!='' && $('#biometric_id').val()!='' && $('#employee_id').val()!='' && $('#department').val()!='' && $('#designation').val()!='' && $('#doj').val()!='' && $('#status').val()!='' && $('#esic_number').val()!='' && $('#epf_number').val()!='' && $('#lin_number').val()!='' && $('#uan_number').val()!='')
				{
					$count++;
				}				
			if($count>0)
	...
	$(document).ready(function(){
		...
		$('#employee_id,#department,#designation,#doj,#status,#genesis_ledger_id,#genesis_id,#biometric_id,#esic_number,#epf_number,#lin_number,#uan_number','#reason_for_code','#last_working_day').blur(function(){
			company_details();
		});
